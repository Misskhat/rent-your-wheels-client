...
const Navbar = () => {
    ...
    return (
        <div className="md:w-11/12 mx-auto my-5">
            <div>
                <div className="md:navbar md:bg-base-100  md:rounded-b-2xl">
                    ...
                    <div className="navbar-end md:px-8 font-bold ">
                        {!user ? (
                            <div className="dropdown dropdown-end">
                                <div tabIndex={0} role="button" className="relative">
                                    <div className="absolute md:w-[50px] md:h-[50px] w-[30px] h-[30px] rounded-full border-2 border-[#13c7e8] -left-10 -top-5 ">
                            ...
                            <Link
                                className="md:border-2 border-[#12d8fa] px-8 py-2 rounded hover:bg-[#12d8fa] transition-all duration-300  hover:text-white"
                                to={"/login"}
                            >
                                Login
                            </Link>
